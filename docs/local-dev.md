...
- If you change the `FRONTEND_API_KEY` in `.env`, you need to delete the stale `api_keys.db` and restart the backend — it only auto-creates the user when no users exist.
