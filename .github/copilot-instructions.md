...
- The backend uses a **5-agent pipeline** (`pipeline_service.run_pipeline`): data validation → statistical analysis → model selection → forecasting → report generation.
