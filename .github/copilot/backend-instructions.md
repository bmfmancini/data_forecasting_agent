...
- Apply caching consistently with existing patterns (`st.cache_data` where appropriate)
...
*This file was generated automatically for backend code using the Copilot Instructions Blueprint Generator.*
