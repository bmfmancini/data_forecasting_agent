...
- Use parameterized queries matching existing patterns (if any data access occurs)
- Follow established authentication and authorization patterns
- Handle sensitive data according to existing patterns

### Accessibility
- Follow existing accessibility patterns in the codebase
- Match ARIA attribute usage with existing components (if applicable)
- Maintain keyboard navigation support consistent with existing UI code
...
- Match dependency injection approaches used in the codebase (if any)
...
*This file was generated automatically for frontend code using the Copilot Instructions Blueprint Generator.*
