...
class TestVisualizationUtils(unittest.TestCase):
    ...
    def test_import_visualization_utils(self):
        ...
        try:
            from utils.visualization_utils import DynamicVisualizer, render_visualization_from_llm, parse_llm_visualization_response
    ...
    def test_parse_llm_visualization_response_with_json(self):
        ...
        response = '{"data": {"x": [1, 2, 3], "y": [1, 2, 3]}, "layout": {"title": "Test"}}'
