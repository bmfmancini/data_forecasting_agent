...
def render_trace_tab(result):
    ...
    st.write(
        "This log shows the internal 'monologue' and tool usage of the AI agents as they processed your request."
    )
    ...
    st.info(
        "💡 These reasoning traces are also shown inline within each specific analysis tab."
    )
