...
STATISTICAL_ANALYSIS_PROMPT = ChatPromptTemplate.from_messages(
    [
        ...
        (
            ...
            "If missing, output INSUFFICIENT_EVIDENCE. Treat detected change "
            "points as candidates: first recommend validating break dates, effect "
            "sizes, and persistence. Only after a durable break is validated may "
            "you suggest comparing intervention terms, recency weighting, "
            "segmentation, or regime-specific models; do not prescribe one.\n\n"
            "5. SIGNAL QUALITY\n"
